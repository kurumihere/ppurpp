...
call s:hi("Visual", s:fg, s:accent_alt, "NONE")
...
call s:hi("LspReferenceText", s:fg, s:accent_alt, "NONE")
call s:hi("LspReferenceRead", s:fg, s:accent_alt, "NONE")
call s:hi("LspReferenceWrite", s:fg, s:accent_alt, "NONE")
...
if has("nvim")
  ...
  call s:hi("@text.literal", s:fg, s:accent_alt, "NONE")
  call s:hi("@text.reference", s:fg, s:accent_alt, "NONE")
  call s:hi("@keyword", s:accent_alt, "", "bold")
  call s:hi("@operator", s:fg, "", get(g:, "ppurpp_italic_operators", 0) ? "italic" : "NONE")
  call s:hi("@function", s:accent, "", "NONE")
